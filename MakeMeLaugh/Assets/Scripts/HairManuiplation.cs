...
public class HairManuiplation : MonoBehaviour {
    ...
    void Update() {
        ...
        {
            curvature = Mathf.Lerp(min, maxBias, Mathf.SmoothStep(0,1, t_breathing));
            
            t_breathing += 0.4f * Time.deltaTime;
